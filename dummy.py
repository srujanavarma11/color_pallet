...
#                 hair_match = any(hair_range[i][0] <= hair_color_int <= hair_range[i][1] for i in range(len(hair_range)))
#                 lips_match = any(lips_range[i][0] <= lips_color_int <= lips_range[i][1] for i in range(len(lips_range)))
#                 skin_match = any(skin_range[i][0] <= cheek_color_int <= skin_range[i][1] for i in range(len(skin_range)))

#                 if hair_match and lips_match and skin_match:
#                     matching_palettes.append(palette_name)

#             if matching_palettes:
#                 print(f"Detected color palettes: {', '.join(matching_palettes)}")
#             else:
#                 print("No matching color palette found.")
...
# Replace 'path_to_your_image.jpg' with your actual image path
image_path = 'C:/Users/sruja/Downloads/Color_Palette_Analyzer-main/Color_Palette_Analyzer-main/image5.jpg'
extract_hexcodes(image_path)
